...
- Rozliczenia, only the additive billing payer note on payer detail, additive payment operational status on payment detail, and append-only billing work queue decision on `/rozliczenia/sprawy`.
