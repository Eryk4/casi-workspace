import { Bell, CircleHelp, Plus, RefreshCw, Search } from "lucide-react";
    ...
    <header className="app-topbar">
      <div className="app-topbar__module">
        <div className="app-topbar__module-meta">
          <span className="app-topbar__eyebrow">Aktualny moduł</span>
      ...
      <div className="app-topbar__actions">
        {showOrganizationSelector ? (
          <label className="app-topbar__organization">
            ...
            >
              {organizationStatus === "loading" ? <option value="">Ładowanie organizacji...</option> : null}
              {organizations.length > 1 ? <option value="">Wybierz organizację</option> : null}
        ...
        {organizationStatus === "error" || organizationStatus === "unauthenticated" ? (
          <div className="app-topbar__session-alert" role="status">
            ...
            {organizationStatus === "unauthenticated" ? <Link href="/login">Zaloguj się</Link> : <span>Odśwież widok</span>}
          </div>
        ) : null}
        {sessionAttention ? (
          <div className="app-topbar__session-alert" role="status">
        ...
        <button className="app-topbar__profile" type="button" aria-label="Profil użytkownika">
