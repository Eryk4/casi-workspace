...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    description: "Dzisiejsze sygnaly wymagajace uwagi w jednej liscie.",
    actionLabel: "Odswiez pulpit dnia",
    readiness: "foundation",
    readinessLabel: "Read-only",
    primaryEndpoint: "multiple read-only endpoints",
  },
  {
    id: "assistant-ceo",
  ...
  },
  {
    ...
    description: "Klienci organizacji, naliczenia, wplaty i alokacje.",
